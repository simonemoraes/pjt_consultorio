...
class MedicosList extends TPage
{
    ...
    private static $formName = 'formList_Medicos';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de médico');
        ...
        $row4 = $this->form->addFields([new TLabel('CRM:', null, '14px', null)],[$crm]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['MedicoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $column_cpf = new TDataGridColumn('cpf', 'CPF', 'left', '200px');
        ...
        $action_onDelete = new TDataGridAction(array('MedicosList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Pessoas','Médico']));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Medicos
