...
class MedicoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $contato_medico_email->setExitAction(new TAction([$this,'verificaCampoEmail']));
    ...
    public static function verificaCampoEmail($param = null) 
    {
        try 
        {
            ...
            if(isset($param['contato_medico_email']) && !empty($param['contato_medico_email'])){
                $email = $param['contato_medico_email'];
