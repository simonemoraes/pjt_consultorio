...
class TipoAtendimentoList extends TPage
{
    ...
    private static $activeRecord = 'TipoAtendimento';
    private static $primaryKey = 'id';
    private static $formName = 'formList_TipoAtendimento';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de tipo de  atendimento');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['TipoAtendimentoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('TipoAtendimentoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TipoAtendimentoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros Básicos','Tipo de  Atendimento']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoAtendimento($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoAtendimento
