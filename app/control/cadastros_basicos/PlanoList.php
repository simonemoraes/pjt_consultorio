...
class PlanoList extends TPage
{
    ...
    private static $formName = 'formList_Plano';
    ...
    public function __construct()
    {
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['PlanoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $container->add(TBreadCrumb::create(['Cadastros Básicos','Plano']));
