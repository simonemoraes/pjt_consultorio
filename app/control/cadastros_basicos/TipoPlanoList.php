...
class TipoPlanoList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'TipoPlano';
    private static $primaryKey = 'id';
    private static $formName = 'formList_TipoPlano';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de Tipo de Plano');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['TipoPlanoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('TipoPlanoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TipoPlanoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros Básicos','Tipo de plano']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoPlano($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoPlano
