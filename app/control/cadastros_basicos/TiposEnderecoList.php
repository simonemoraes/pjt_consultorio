...
class TiposEnderecoList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TiposEnderecos';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de Tipos de  Endereço');
        ...
        $row2 = $this->form->addFields([new TLabel('Tipo de Endereço:', null, '14px', null)],[$descricao]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['TipoEnderecoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $column_descricao = new TDataGridColumn('descricao', 'Tipo de Endereço', 'left');
        ...
        $action_onEdit = new TDataGridAction(array('TipoEnderecoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TiposEnderecoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros Básicos','Tipos de  Endereço']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TiposEnderecos($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TiposEnderecos
